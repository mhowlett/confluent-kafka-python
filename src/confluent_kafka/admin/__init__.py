...
class ConfigSource(Enum):
    """
    Enumerates the different sources of configuration values. Used by ConfigEntry to specify the
    source of configuration values returned by `describe_configs()`.
    """
...
class ConfigResource(object):
    ...
    a collection of configuration values for that resource. Used by
    ...
    class Type(Enum):
        """
        Enumerates the different types of a Kafka resources.
        """
